...
@dateWritten=2024-09-02T11:44:52Z
...
@institute3=NL-LAB
@language=it
@levelConstraints=note < chunk, p; salute < opener, closer; profileDesc < chunk; head < chunk; p < chunk; fileDesc < chunk; note < chunk
@schema=TEI + suriano
...
@writtenBy=Text-Fabric
@dateWritten=2024-09-02T11:48:48Z
