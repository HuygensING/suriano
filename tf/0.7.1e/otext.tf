...
@dateWritten=2024-10-08T12:15:15Z
...
@institute3=NL-LAB
@language=it
@levelConstraints=note < chunk, p; salute < opener, closer; note < chunk; fileDesc < chunk; head < chunk; p < chunk; profileDesc < chunk
@schema=TEI + suriano
...
@writtenBy=Text-Fabric
@dateWritten=2024-10-09T16:20:41Z
