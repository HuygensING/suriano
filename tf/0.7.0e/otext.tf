...
@dateWritten=2024-09-18T22:11:06Z
...
@institute3=NL-LAB
@language=it
@levelConstraints=note < chunk, p; salute < opener, closer; note < chunk; profileDesc < chunk; head < chunk; fileDesc < chunk; p < chunk
@schema=TEI + suriano
...
@writtenBy=Text-Fabric
@dateWritten=2024-09-18T22:13:19Z
