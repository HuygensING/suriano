...
@dateWritten=2024-08-13T13:58:24Z
...
@institute3=NL-LAB
@language=it
@levelConstraints=note < chunk, p; salute < opener, closer; profileDesc < chunk; fileDesc < chunk; note < chunk; p < chunk
@schema=TEI + suriano
...
@writtenBy=Text-Fabric
@dateWritten=2024-08-13T14:41:55Z
