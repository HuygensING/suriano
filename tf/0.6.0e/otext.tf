...
@dateWritten=2024-09-16T14:01:02Z
...
@institute3=NL-LAB
@language=it
@levelConstraints=note < chunk, p; salute < opener, closer; note < chunk; p < chunk; fileDesc < chunk; profileDesc < chunk
@schema=TEI + suriano
...
@writtenBy=Text-Fabric
@dateWritten=2024-09-16T14:04:21Z
