...
@institute3=NL-LAB
@language=it
@levelConstraints=note < chunk, p; salute < opener, closer; profileDesc < chunk; fileDesc < chunk; note < chunk; p < chunk; head < chunk
@schema=TEI + suriano
...
@dateWritten=2025-03-05T12:36:17+00:00Z
