...
@writtenBy=Text-Fabric
@dateWritten=2024-08-08T11:27:36Z
...
Need to double check this letter again

Need to double check letter again


Attached to this letter is Au serenissime Prince de Venise (fol 140r-141v) in French
...
Attached to this letter two documents Offerta del signor conte Gio. di Nassau per cavalleria and Offerta del signor conte Gio. di Nassau




Attached to the letter is the account of Thomas Studder’s career

Added document to the letter is Scrittura de risposta de’ signori Stati (Resolutiën SG, p. 723)

Document Polizza delle navi attached to this letter
Scrittura per raccordo is attached to this letter
Offerta del baron di Pallie and Copia della lettera a sua Serenità consegnate a monsignor Bouier
...
Document attached Offerta del colonel Tomas Gaes (54 years old, travelled to Santo Domingo with Drake and has served the SG for over 38 years)
...
Document attached is Copy of the patent given by Maurice of Nassau to Jan Jansen van Enkhuizen (Copia della patente data dal principe Mauritio ai patroni di vasselli colegati)




Attached to the letter Nella prima lettera delli signori Stati Generali per li cap(itol)i de’ patroni di vasseli con le genti per sua Serenità





Polizza is an insurance
...
Need to look at last part of the letter: I do not know what he is talking about: need to look at letter from 31 december 1616

the following document is attached to the letter: Lettera del Rocalaura del 26 febbraio 1617
...
Documents attached to the letter are Navi che possino servire per armarsi ad uso di guerra and Ricevuta
...
Attached to this letter are two documents: lettera del re della Gran Bretagna alli Signori Stati del 20 marzo 1617 and copia della lettera mandata ad Antonio Liguori dal Zanthe del 2 maggio 1617
